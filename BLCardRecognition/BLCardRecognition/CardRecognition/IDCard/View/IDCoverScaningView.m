...
@implementation IDCoverScaningView
...
-(void)addScaningWindow {
    ...
    CGFloat facePathWidth = iPhone5or5cor5sorSE? 60: (iPhone6or6sor7? 80: 110);
...
-(void )addTipLabelWithText:(NSString *)text center:(CGPoint)center {
    ...
    NSRange range=[[tip string]rangeOfString:@"身份证国徽"];
