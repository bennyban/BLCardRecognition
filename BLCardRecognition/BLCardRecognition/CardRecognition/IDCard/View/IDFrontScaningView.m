...
@implementation IDFrontScaningView
...
-(void)addScaningWindow {
    ...
    CGFloat facePathWidth = iPhone5or5cor5sorSE? 125: (iPhone6or6sor7? 145: 170);
...
-(void )addTipLabelWithText:(NSString *)text center:(CGPoint)center {
    ...
    NSRange range=[[tip string]rangeOfString:@"身份证人像面"];
