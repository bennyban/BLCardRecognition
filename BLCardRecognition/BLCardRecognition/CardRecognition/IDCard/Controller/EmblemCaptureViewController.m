...
#import "IDCoverScaningView.h"

@interface EmblemCaptureViewController ()<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegate>
...
@implementation EmblemCaptureViewController
...
-(void)turnOnOrOffTorch {
    ...
    if ([self.device hasTorch]){ // 判断是否有闪光灯
        ...
        IDCoverScaningView *IDCardScaningView = (IDCoverScaningView *)[self.view viewWithTag:1006];
